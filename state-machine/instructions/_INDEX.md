...
| Theme work (mysps) | `FEATURE_THEME_MYSPS`, `INDEX_THEME_MYSPS_TEMPLATES` |
...
| `FEATURE_THEME_MYSPS` | MySPS child theme scope |
...
|--------------|-----------|
| Block registration | `mu-plugins/editor/init-sps-blocks.php` |
| Notification system | `mu-plugins/editor/init-sps-notifications.php` |
| Block fields | `mu-plugins/editor/fields/fields-*.php` |
| Block render | `mu-plugins/editor/sps-*-block/render.php` |
| Block JSON | `mu-plugins/editor/sps-*-block/block.json` |
...
| Base theme | `themes/sps-base-blade/` |
| District theme | `themes/sps-district-blade/` |
| Schools theme | `themes/sps-schools-blade/` |
| MySPS theme | `themes/mysps-blade/` |
...
| Legacy MySPS theme | `wp-content/themes-legacy/mysps/` |
| Legacy District theme | `wp-content/themes-legacy/sps-district/` |
| Legacy Schools theme | `wp-content/themes-legacy/sps-schools/` |
| Legacy Base theme | `wp-content/themes-legacy/sps-base-theme/` |
