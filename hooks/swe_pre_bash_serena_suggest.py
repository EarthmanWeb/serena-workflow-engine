...
FEATURE_KEYWORDS = {
    'BLOCKS': ['block', 'blocks', 'acf', 'editor', 'gutenberg', 'custom-block', 'render', 'fields'],
    'CONTEXT_PROVIDERS': ['provider', 'context', 'blade', 'bladeone', 'view', 'viewmodel', 'template-data'],
    'THEME_BASE': ['theme', 'base-theme', 'base-theme', 'parent-theme', 'base-blade'],
    'THEME_DISTRICT': ['district', 'district', 'district-blade'],
    'THEME_SCHOOLS': ['schools', 'schools', 'schools-blade'],
    'THEME_REDACTED': ['app', 'app', 'app-blade'],
