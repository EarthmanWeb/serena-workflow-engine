...
- Copies files from `$SWE_PLUGIN_ROOT/memories/` TO `.serena/swe/`
...
cp -n $SWE_PLUGIN_ROOT/memories/**/*.md .serena/swe/
# Or for specific files:
cp $SWE_PLUGIN_ROOT/memories/wf/WF_CLASSIFY.md .serena/swe/wf/
```
