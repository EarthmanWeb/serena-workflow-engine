...
```
✅ User: "Launch ruv-swarm to detect features"
✅ Agent: [Uses mcp__ruv-swarm__swarm_init(), etc.]
```
...
> "Research existing patterns in INDEX__, ARCH__, SYS_* memories before implementing. DO NOT create anything that already exists."
