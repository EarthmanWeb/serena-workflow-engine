...
def main():
    ...
    wp_cli_setup_needed = (
        _detect_framework_type(project_root) == 'wordpress'
        and os.path.isdir(os.path.join(project_root, '.devcontainer'))
        and not os.path.exists(os.path.join(project_root, '.serena', 'wp-cli.conf'))
    )
